  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Novi outfit</h1>
      </div>
      ...
      <form onSubmit={handleSubmit}>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">
                  Unesite URL slike ili kliknite „Izaberi iz galerije” da otpremite sliku sa računara.
                </p>
              </div>
        ...
        <div className="flex justify-end gap-4 mt-6">
          ...
          <Button
            ...
            disabled={isLoading}
          >
            {isLoading ? "Čuvanje..." : "Sačuvaj outfit"}
          </Button>
        </div>
      </form>
    </div>
